...
{
    internal class TemperatureData // TemperatureData är vår andra klass.   -------
    {
        ...
        public void PrintDateTemperature() // void är en returtyp som ej returnerar något värde.Metoden utför bara en uppgift men ger inte tillbaka något resultat ----------- 
        {
        ...
        public void GetMedianTemperature()
        {
            ...
            for (int i = 0; i < 31; i++)
            {
                ...
                if (31 % 2 != 0)
                {
                    medianTemperature = temporaryArray[(31 / 2) - 1]; //  efter beräkningen  så blir elementet i arrayen placerats i mitten medianvärdet
