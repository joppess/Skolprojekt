    ...
    internal class TemperatureData
    {
        ...
        public void GetMedianTemperature()
        {
            ...
            for (int i = 0; i < 31; i++)
            {
                ...
                if (31 % 2 != 0)
                {
                    medianTemperature = days[31 / 2]; //  efter beräkningen  så bir elementet i arrayen placerats i mitten medianvärdet
        ...
        public void PrintSpecificDates()
        {
            ...
            else if (choice >= 1 && choice <= 31)
            {
                ...
                Console.WriteLine($" Dagen innan {dateTime.ToString("yyyy/MM/dd")} erbjuder {days[choice]}C");
        ...
        public void PrintMostCommonTemp()
        {
            ...
            for (int i = 0; i < 31; i++)
            {
                int currentDayTemp = days[i]; // hämtar temperaturen för dagen det gäller
            ...
            int commonTemp = 0; // vi sparar den vanligast förekommande temperaturen
            int highestTempCount = 0; // vi sparar hur många gånger den uppenbarar sig

            // iteration genom varje nyckel och värde
            foreach (var temp in mostCommonTemp)
            {
                // om antalet av en temperatur (temp.Value) är större än det största antalet som registrerats
