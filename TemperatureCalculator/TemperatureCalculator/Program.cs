...
{
    internal class Program // Program är vår klass                     -------
    {
        static void Main(string[] args)
        {
            ...
            while (menuLoop)
            {
                ...
                Console.WriteLine(" val 4 skriv ut lägsta temperaturen i Maj");
                ...
                {
                    Console.WriteLine(" Fel inmatning. Försök igen (måste vara ett tal i listan) ");
                    Console.Write("\n");
                    continue;
                }
