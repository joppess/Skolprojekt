...
namespace TireReplacementService
{
    internal class Program
    {
        ...
        static void AvailableAppointments()
        {
            ...
            //  vi loopar igenom alla lediga tider och skriver ut de med hjälp av ToString
        ...
        static void RescheduleAppointment()
        {
            ...
            if (DateTime.TryParse(oldAppointment, out DateTime dateTime))
            {
                ...
                if (booking != null)
                {
                    ...
                    string? newAppointment = Console.ReadLine();
                    if (DateTime.TryParse(newAppointment, out DateTime newDateTime)) // vi kontrollera om den nya tiden blev inskriven i rätt format 
                    {
